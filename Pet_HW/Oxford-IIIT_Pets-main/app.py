...
# Modeli yükle
model_path = r"C:\Users\Lenovo\Desktop\Github Turkcell\Github_TurkcellGYK\Pet_HW\Oxford-IIIT_Pets-main\oxford_pets_model.h5"
...
def index():
    ...
    if request.method == 'POST':
        ...
        if file:
            ...
            # 🔧 Fix: image_url sadece HTML tarafı için uygun hale getirildi
            ...
            if confidence < CONFIDENCE_THRESHOLD:
                prediction = "Hayvan türü bulunamadı."
            else:
